...
title: “Authentication with flowfabricr” output:
rmarkdown::html_vignette vignette: \> % % \# Authentication
...
[`flowfabric_token()`](../reference/flowfabric_token.md), leveraging the
`hfutils` package for OAuth2 flows. You can also set or override the
token explicitly for any function call. \## Background (global) token
